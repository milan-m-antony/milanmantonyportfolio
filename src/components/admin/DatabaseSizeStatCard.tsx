...
interface DatabaseSizeStatCardProps {
  title: string;
...
const DatabaseSizeStatCard: React.FC<DatabaseSizeStatCardProps> = ({
  title,
  currentSizeMB,
  maxSizeMB,
  description,
  ...
  const actualMaxSizeMB = maxSizeMB === null || typeof maxSizeMB === 'undefined' ? 1024 : maxSizeMB; // Default to 1GB for DB if not provided
        ...
        <CardContent className="flex-grow flex flex-col items-center justify-center text-center">
          {isLoading ? (
            <div className="flex flex-col items-center justify-center py-4">
              ...
              <p className="text-xs text-muted-foreground">Loading database size...</p>
            </div>
          ) : currentSizeMB !== null ? (
            <>
            ...
            <div className="flex flex-col items-center justify-center py-4">
              <DatabaseIcon className="h-10 w-10 text-muted-foreground mb-3" />
...
export default DatabaseSizeStatCard; 